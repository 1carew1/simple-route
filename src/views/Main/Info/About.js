  ...
  render() {
  	return (
          ...
          <Jumbotron>
            ...
            <p>It is written using React with the Create React App tool used for the initial setup. The Github link of this can be found : <a href="https://github.com/1carew1/simple-route">Here</a></p>
          </Jumbotron>
        </div>
  	);
  }
